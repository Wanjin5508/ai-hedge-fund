...
def generate_fisher_output(
    ...
    template = ChatPromptTemplate.from_messages(
        [
            ...
            (
              "human",
              """Based on the following analysis, create a Phil Fisher-style investment signal. and make sure to use Chinese so that your customers from China can understand
